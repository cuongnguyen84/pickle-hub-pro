...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-sidebar-background border-r border-sidebar-border transform transition-transform duration-200 ease-out lg:translate-x-0 ${
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile header */}
        <header className="lg:hidden h-16 flex items-center gap-4 px-4 border-b border-border">
          <Button
            variant="ghost"
            size="icon"
