...
const SELLER_NAV: {
  ...
  { key: "products", label: "Sản phẩm", short: "Sản phẩm", to: "/seller/products/import", Icon: Package, ready: true },
  { key: "orders", label: "Đơn hàng", short: "Đơn", to: "/seller/orders", Icon: ClipboardList, ready: false },
  { key: "settings", label: "Cài đặt", short: "Cài đặt", to: "/seller/settings", Icon: Settings, ready: false },
];
...
const ADMIN_SHOP_NAV = [
  ...
  { to: "/admin/shop/products", label: "Sản phẩm", ready: false },
