    ...
    >
      <main className="mx-auto w-full max-w-3xl px-4 py-12 text-foreground-secondary">
        ...
        <div className="space-y-8 leading-relaxed">
          ...
          <section><h2 className="mb-3 text-xl font-semibold text-foreground">{vi ? "Người xây dựng" : "Who builds ThePickleHub"}</h2><p><Link to={vi ? "/vi/authors/cuong-nguyen" : "/authors/cuong-nguyen"}>Cuong Nguyen</Link> — {vi ? "người xây dựng nền tảng và cộng tác nội dung về pickleball Việt Nam, châu Á." : "builder and contributor covering pickleball in Vietnam and Asia."}</p></section>
