...
const QuickTables = () => {
  ...
  const [tableName, setTableName] = useState('Bảng đấu mới');
        ...
        <div className="container-wide py-8">
          <div className="max-w-lg mx-auto text-center">
            ...
            <p className="text-foreground-muted mb-6">
              Vui lòng đăng nhập để tạo bảng đấu mới.
            </p>
            <Link to="/login">
          ...
          {step === 'count' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Nhập tổng số người chơi tham gia giải đấu
                </CardDescription>
              </CardHeader>
          ...
          {step === 'format' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {playerCount} người chơi - {suggestedFormat === 'round_robin' 
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {suggestedFormat === 'round_robin' && (
                            <Badge variant="default" className="text-xs">Khuyến nghị</Badge>
                          )}
                        </div>
                        <p className="text-sm text-foreground-secondary">
                          Chia người chơi thành các bảng, mỗi người đấu với tất cả người khác trong bảng.
                          Top của mỗi bảng sẽ vào vòng Playoff.
                        </p>
                        {playerCount > 48 && (
                          <p className="text-sm text-destructive mt-1">
                            Không khả dụng với &gt;48 người
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-foreground-secondary">
                          Thể thức dành cho giải đông người. Lượt 1-2 ghi nhận thắng/thua và hiệu số,
                          từ lượt 3 trở đi là single elimination.
                        </p>
                        {playerCount < 32 && (
                          <p className="text-sm text-destructive mt-1">
                            Chỉ khả dụng với ≥32 người
                          </p>
                        )}
                      </div>
                    </div>
          ...
          {step === 'groups' && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Chọn cách chia {playerCount} người chơi vào các bảng
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
