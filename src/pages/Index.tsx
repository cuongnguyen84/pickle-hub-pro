  ...
  return <MainLayout>
        ...
        <div className="container-wide py-16 md:py-24 lg:py-32">
          <div className="max-w-2xl space-y-6 animate-fade-in">
            ...
            <h1 className="text-foreground text-balance">
              ThePickleHub – Leading Pickleball Platform
            </h1>
            
            <p className="text-lg text-foreground-secondary leading-relaxed">Watch live pickleball tournaments, follow brackets, and connect with the most vibrant pickleball community.</p>
      ...
      <section className="container-wide py-12 bg-surface-elevated rounded-xl mb-8">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <p className="text-foreground-secondary leading-relaxed">ThePickleHub is a comprehensive pickleball platform for the community. We provide live tournament streaming, automatic bracket management tools, and a space for players to connect. Whether you're a beginner or experienced, ThePickleHub is where you watch, learn, and improve your pickleball skills.</p>
