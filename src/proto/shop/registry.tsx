...
export const SCREENS: ProtoScreen[] = [
  ...
  // ── B2 — buyer transaction + support ────────────────────────────────────
  {
    id: "B08",
    title: "Giỏ hàng /shop/cart",
    batch: "B2",
    route: "cart",
    Component: lazy(() => import("./screens/B08Cart")),
    shots: [
      s("two-sellers", "/cart", [375, 1440]),
      s("empty", "/cart?scenario=empty", [375]),
      s("price-and-stock", "/cart?scenario=unavailable", [375]),
      s("seller-suspended", "/cart?scenario=suspended", [375]),
      s("error", "/cart?scenario=error", [375]),
    ],
  },
  {
    id: "B09",
    title: "Đặt hàng /shop/checkout/:shopId",
    batch: "B2",
    route: "checkout/:shopId",
    Component: lazy(() => import("./screens/B09Checkout")),
    shots: [
      s("saved-address", "/checkout/shop-1", [320, 375, 768, 1440]),
      s("new-address", "/checkout/shop-1?variant=new-address", [375]),
      s("address-error", "/checkout/shop-1?variant=address-error", [375]),
      s("no-shipping", "/checkout/shop-1?variant=no-shipping", [375]),
      s("vietqr", "/checkout/shop-1?variant=vietqr", [375, 1440]),
      s("stock-changed", "/checkout/shop-1?variant=stock-changed", [375]),
      s("submitting", "/checkout/shop-1?variant=submitting", [375]),
      s("payment-failed", "/checkout/shop-1?variant=payment-failed", [375]),
    ],
  },
  {
    id: "B10",
    ...
    batch: "B2",
    route: "order-success",
    Component: lazy(() => import("./screens/B10OrderSuccess")),
    shots: [
      s("cod", "/order-success?variant=cod", [375, 1440]),
      s("awaiting-transfer", "/order-success?variant=awaiting", [375, 1440]),
      s("confirmed", "/order-success?variant=confirmed", [375]),
    ],
  },
  {
    id: "B11",
    ...
    batch: "B2",
    route: "orders",
    Component: lazy(() => import("./screens/B11Orders")),
    shots: [
      s("mixed", "/orders", [375, 1440]),
      s("empty", "/orders?scenario=empty", [375]),
      s("error", "/orders?scenario=error", [375]),
    ],
  },
  {
    id: "B12",
    title: "Chi tiết đơn /shop/order/:code",
    batch: "B2",
    route: "order/:orderCode",
    Component: lazy(() => import("./screens/B12OrderDetail")),
    shots: [
      s("processing", "/order/PH-2608-0039", [375, 1440]),
      s("awaiting-payment", "/order/PH-2608-0041", [375]),
      s("shipped", "/order/PH-2608-0031", [375]),
      s("delivered", "/order/PH-2607-0018", [375]),
      s("cancelled", "/order/PH-2607-0009", [375]),
      s("return", "/order/PH-2607-0022", [375]),
      s("dispute", "/order/PH-2607-0025", [375, 1440]),
      s("refunded", "/order/PH-2606-0003", [375]),
    ],
  },
  {
    id: "B13",
    ...
    batch: "B2",
    route: "return",
    Component: lazy(() => import("./screens/B13Return")),
    shots: [
      s("eligible", "/return", [375, 1024]),
      s("ineligible", "/return?variant=ineligible", [375, 1024]),
      s("upload-error", "/return?variant=upload-error", [375]),
      s("submitted", "/return?variant=submitted", [375]),
    ],
  },
  {
    id: "B14",
    ...
    batch: "B2",
    route: "dispute/:id",
    Component: lazy(() => import("./screens/B14Dispute")),
    shots: [
      s("awaiting-seller", "/dispute/dis-1", [375, 1440]),
      s("awaiting-buyer", "/dispute/dis-2", [375]),
      s("admin-review", "/dispute/dis-3", [375]),
      s("resolved-buyer", "/dispute/dis-4", [375, 1440]),
      s("resolved-seller", "/dispute/dis-5", [375]),
    ],
  },
  {
    id: "B15",
    ...
    batch: "B2",
    route: "review",
    Component: lazy(() => import("./screens/B15Review")),
    shots: [
      s("eligible", "/review", [375, 1024]),
      s("already", "/review?variant=already", [375]),
      s("not-yet", "/review?variant=not-yet", [375]),
      s("invalid", "/review?variant=invalid", [375]),
