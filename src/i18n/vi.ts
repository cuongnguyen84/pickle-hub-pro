...
export const vi: Translations = {
  ...
  privacy: {
    ...
    rights: {
      ...
      items: {
        ...
        edit: "Yêu cầu chỉnh sửa hoặc xóa tài khoản",
    ...
    shop: {
      title: "Dữ liệu của Shop",
      description:
        "Khi bạn mua hoặc bán hàng qua Shop, ThePickleHub xử lý thông tin cần thiết để hiển thị sản phẩm, tạo và giao đơn, xác nhận thanh toán, hỗ trợ hoàn tiền và giải quyết vấn đề phát sinh. ThePickleHub không thu thập mật khẩu ngân hàng hoặc dữ liệu thẻ thanh toán.",
      groups: {
        public:
        ...
        internal:
          "Chỉ hiển thị cho các bên cần xử lý: họ tên, số điện thoại và địa chỉ lấy hàng trong hồ sơ người bán; tên người nhận, số điện thoại, địa chỉ giao hàng, ghi chú và các món trong đơn; thông tin tài khoản nhận chuyển khoản do shop khai. Địa chỉ lấy hàng và giao hàng không hiển thị công khai, và email hay số điện thoại tài khoản không bao giờ tự động trở thành kênh liên hệ công khai.",
        consent:
        ...
        moderation:
          "Nhật ký vận hành: quyết định kiểm duyệt, thay đổi trạng thái đơn, thời điểm báo hoặc xác nhận thanh toán, mã tham chiếu giao dịch từ cổng thanh toán và việc hoàn tiền. Nhật ký kiểm duyệt kênh liên hệ chỉ ghi loại kênh thay đổi, không ghi giá trị; ghi chú nội bộ của quản trị viên không hiển thị cho người bán.",
      },
      purpose:
        "Dùng để xét duyệt người bán, hiển thị shop và sản phẩm, thực hiện đơn hàng, đối soát thanh toán, hỗ trợ giao nhận, hoàn tiền, chống gian lận và xử lý khiếu nại.",
      retention:
        "Hồ sơ đăng ký và bằng chứng chấp thuận bị xoá cùng tài khoản của bạn. Đơn hàng và nhật ký cần cho giao nhận, thanh toán, hoàn tiền hoặc đối chiếu có thể được giữ lại; khi người mua xoá tài khoản, liên kết tới tài khoản được gỡ nhưng thông tin giao nhận đã lưu trong đơn vẫn còn trong thời gian cần thiết. Nếu bạn đang sở hữu một shop, shop phải được xử lý trước thì tài khoản mới xoá được.",
    },
    effective: {
  ...
  account: {
    ...
    deleteBlockedShopOwnerWhy:
      "Shop còn sản phẩm, đơn hàng, hình ảnh và lịch sử kiểm duyệt. ThePickleHub xử lý việc đóng shop thủ công để bảo toàn dữ liệu cần đối chiếu và không xoá nhầm nội dung cần giữ.",
  ...
  quickTable: {
    ...
    view: {
      ...
      deleteConfirm: "Bạn có chắc chắn muốn xóa giải \"{name}\"? Tất cả dữ liệu (VĐV, trận đấu, đăng ký...) sẽ bị xóa vĩnh viễn.",
      deleteBtn: "Xóa giải",
      ...
      inputScore: "Nhập",
      loading: "Đang tải...",
      deleteTournament: "Xóa giải",
      deleteConfirmFull: "Bạn có chắc chắn muốn xóa giải \"{name}\"? Tất cả dữ liệu sẽ bị xóa vĩnh viễn.",
      recommended: "Khuyến nghị",
      confirm: "Xác nhận",
      cancel: "Hủy",
      move: "Chuyển",
  ...
  doublesElimination: {
    ...
    setup: {
      ...
      minTeamsError: "Cần tối thiểu 40 đội",
      ...
      need32Teams: "Cần ít nhất 40 đội",
  ...
  socialEvents: {
    ...
    proxyRegister: {
      ...
      prepaymentSkipWarning:
        "Bạn đã đăng ký giúp {name}. Đây là sự kiện bắt buộc thanh toán trước nên slot sẽ tự động bị hủy sau {hours} giờ nếu không hoàn tất chuyển khoản.",
    ...
    create: {
      ...
      requirePrepaymentDescription:
        "Player phải hoàn tất chuyển khoản trong thời gian quy định, nếu không đăng ký sẽ tự động bị hủy.",
      paymentDeadlineHours: "Thời hạn thanh toán (giờ)",
      paymentDeadlineHint:
        "Tính từ lúc player đăng ký. Nếu thời hạn vượt qua giờ bắt đầu event, đăng ký bị hủy ngay.",
      ...
      errorSlotDuplicateId: "Nhóm bị trùng id — vui lòng xóa và tạo lại",
    },
    manage: {
      ...
      cancelEventConfirm: "Bạn chắc chắn hủy sự kiện này?",
      cancelEventConfirmBody:
        "Tất cả người đã đăng ký sẽ thấy thông báo \"Sự kiện đã hủy\". Bạn có thể mở lại sau.",
      cancelled: "Đã hủy",
      reopen: "Mở lại",
    ...
    playerRegistration: {
      ...
      eventStartedHint: "Sự kiện đã bắt đầu, không thể hủy/đăng ký lại.",
      eventFullHint: "Sự kiện đã đầy. Bạn không thể đăng ký lại.",
      eventCancelledTitle: "Sự kiện đã bị BTC hủy",
      eventCancelledBody:
        "BTC đã hủy sự kiện này. Đăng ký của bạn coi như đã hủy. Hãy liên hệ BTC để biết thông tin hoàn tiền (nếu có).",
      ...
      saveLinkBody:
        "Bookmark hoặc lưu lại link này — bạn cần nó để xem trạng thái hoặc hủy đăng ký. (Không gửi SMS / email.)",
      ...
      cancelledBanner: "Bạn đã hủy đăng ký sự kiện này",
      ...
      paymentOverdue: "Đã quá hạn thanh toán, đăng ký sẽ sớm bị hủy.",
      ...
      errors: {
        ...
        event_started: "Sự kiện đã bắt đầu, không thể hủy.",
    ...
    entityNotFound: {
      ...
      event: {
        ...
        body: "Sự kiện này có thể đã bị hủy hoặc liên kết không còn chính xác. Hãy thử trang sự kiện công khai.",
        backCta: "Xem sự kiện sắp tới",
      },
      profile: {
        title: "Không tìm thấy người chơi",
        body: "Hồ sơ này có thể đã bị xóa hoặc liên kết không đúng.",
    ...
    editEvent: {
      ...
      readOnlyCancelledTitle: "Sự kiện đã bị hủy",
      readOnlyCancelledBody:
        "Sự kiện này đã bị hủy. Để mở lại, liên hệ admin.",
      dangerZone: "Vùng nguy hiểm",
      cancelEventHeading: "Hủy sự kiện",
      cancelEventBody:
        "Hủy sự kiện này sẽ tự động hủy tất cả đăng ký. Player sẽ thấy banner \"Sự kiện đã bị BTC hủy\". Bạn phải tự refund tiền cho ai đã chuyển khoản.",
      cancelEventCta: "Hủy sự kiện",
      cancelEventModalTitle: "Xác nhận hủy sự kiện",
      cancelEventModalBody:
        "Bạn sắp hủy sự kiện. {n} đăng ký sẽ bị hủy tự động.",
      cancelEventModalInputLabel: "Gõ \"{name}\" để xác nhận",
      cancelEventConfirmCta: "Hủy sự kiện",
      cancelEventCancelling: "Đang hủy…",
      cancelEventSuccessTitle: "Đã hủy sự kiện",
      cancelEventSuccessBody: "Tất cả đăng ký đã được tự động hủy.",
      modalBack: "Quay lại",
    },
    editClub: {
    ...
    managers: {
      ...
      subheading:
        "Người tạo CLB có thể thêm tối đa nhiều người quản lý. Người quản lý có toàn quyền tạo / sửa / hủy sự kiện, sửa thông tin CLB, nhưng KHÔNG thể xóa hay archive CLB.",
      ...
      removeAria: "Xóa người quản lý",
      removeConfirm: "Xóa quyền quản lý của {name}?",
      removeSuccess: "Đã xóa {name} khỏi danh sách quản lý.",
      removeError: "Không thể xóa — vui lòng thử lại.",
      addedBy: "Thêm vào {date}",
      empty: "Chưa có người quản lý nào.",
      ownerOnly: "Chỉ người tạo CLB có thể thêm/xóa quản lý.",
    ...
    members: {
      ...
      approveCta: "Duyệt",
      rejectCta: "Từ chối",
      removeAria: "Xóa thành viên",
      removeConfirm: "Xóa {name} khỏi CLB?",
      removeSuccess: "Đã xóa {name} khỏi danh sách thành viên.",
      removeError: "Không thể xóa thành viên — vui lòng thử lại.",
    ...
    matches: {
      ...
      readyOff: "Đã hủy trạng thái sẵn sàng.",
    ...
    roster: {
      ...
      actionCancel: "Hủy đăng ký",
      actionEditNotes: "Ghi chú",
      confirmCancelTitle: "Hủy đăng ký của người này?",
      confirmCancelBody:
    ...
    payment: {
      ...
      prepaymentWarningDescription:
        "Nếu không hoàn tất thanh toán trong {hours} giờ ({deadline}), đăng ký của bạn sẽ tự động bị hủy.",
      payLater: "Tôi sẽ thanh toán sau",
      unpaidStatusBadge: "Chưa thanh toán",
    },
    profile: {
      notFoundTitle: "Không tìm thấy profile",
      notFoundBody: "Profile này không tồn tại hoặc đã bị xóa.",
      levelLabel: "Level",
  ...
  toast: {
    ...
    table: {
      ...
      removePlayer: {
        permissionDenied: "Bạn không có quyền xóa VĐV",
        error: "Không thể xóa VĐV",
      },
      regenerateGroupMatches: {
      ...
      deleteTable: {
        success: "Đã xóa giải đấu",
        permissionDenied: "Bạn không có quyền xóa giải đấu này",
