...
export const en: Translations = {
  ...
  socialEvents: {
    ...
    paymentSettings: {
      pageTitle: "Accept online payments",
      pageSubtitle: "Players scan a QR and transfer directly to the club's bank account. ThePickleHub never touches the money. One-minute setup.",
      bankLabel: "Bank",
      bankPlaceholder: "Choose a bank",
      accountNumberLabel: "Account number",
      accountNumberInvalid: "Digits only, 3–30 characters.",
      ...
      enabledLabel: "Enable online payments",
      enabledHint: "When off, players see the \"pay at the venue\" hint instead of a QR.",
      saveButton: "Save",
      saving: "Saving…",
      savedToast: "Payment settings saved.",
      previewTitle: "Preview QR",
      previewHint: "Scan with your banking app to verify the info (50,000 ₫, memo PHUB-DEMO00).",
      previewAlt: "Preview VietQR code",
      disabledNotice: "Payments are OFF. Players see the pay-at-venue hint instead of the QR.",
      manageCta: "Payment",
    },
  },
};
