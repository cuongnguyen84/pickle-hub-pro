...
// a static import list would construct all 65 post objects at worker
...
export const blogPostLoaders: Record<string, () => Promise<{ default: BlogPost }>> = {
  ...
  "kuala-lumpur-cup-2026-preview": () => import("./kuala-lumpur-cup-2026-preview"),
  "kuala-lumpur-cup-2026-results": () => import("./kuala-lumpur-cup-2026-results"),
  ...
  "pickleball-world-cup-2026-da-nang-from-the-stands": () => import("./pickleball-world-cup-2026-da-nang-from-the-stands"),
  "pickleball-world-cup-2026-da-nang-how-to-watch": () => import("./pickleball-world-cup-2026-da-nang-how-to-watch"),
  "pickleball-world-cup-2026-da-nang-results": () => import("./pickleball-world-cup-2026-da-nang-results"),
  ...
  "pickleball-world-cup-2026-mens-pro-doubles-field": () => import("./pickleball-world-cup-2026-mens-pro-doubles-field"),
