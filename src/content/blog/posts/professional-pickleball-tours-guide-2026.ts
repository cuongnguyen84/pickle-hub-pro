    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "In March 2024, the Professional Pickleball Association (PPA) and Major League Pickleball (MLP) officially merged into a single parent holding company: the United Pickleball Association, or UPA. The deal received a $75 million investment from private equity firm SC Holdings and unified two organizations that had spent most of 2023 in a hostile bidding war for top players. As of 2026, UPA is the holding company that owns both the PPA Tour and MLP. PPA Tour Asia operates as a UPA-affiliated regional partner. The APP Tour, importantly, is not part of UPA — it remains independent. That platform ambition became concrete in May 2026, when Apollo Sports Capital led a $225 million investment in a newly named parent company, Pickleball Inc. (an expansion of the UPA holding company), valuing the business at roughly $750 million — with Tom Dundon and the Pardoe family remaining majority owners. The capital funds more broadcast deals, international expansion, and tighter integration with the DUPR rating system and with retail and technology platforms such as Pickleball Central and PickleballTournaments.com.",
          internalLinks: [
            {
      ...
      sections: [
        {
          ...
          content:
            "Pickleball chuyên nghiệp năm 2026 chưa bao giờ có tổ chức tốt như hiện tại — và cũng chưa bao giờ phức tạp đến mức này nếu bạn mới theo dõi. Sau Tour Wars hỗn loạn năm 2023 và vụ sáp nhập PPA-MLP đầu năm 2024, hiện có 4 giải chuyên nghiệp lớn cùng hoạt động song song: PPA Tour (giải cá nhân chủ lực ở Mỹ — đơn, đôi, đôi hỗn hợp), Major League Pickleball hay MLP (thể thức đồng đội), PPA Tour Asia (tour khu vực phát triển nhanh nhất), và APP Tour (độc lập với UPA, tập trung vào phát sóng truyền hình và giải đại học). Bài này của ThePickleHub giải thích từng giải hoạt động ra sao trong 2026, khác nhau ở đâu, ai là top VĐV — và quan trọng nhất với độc giả Việt Nam: tất cả những điều này kết nối ra sao với các sự kiện bạn có thể xem và thi đấu thực tế.",
          internalLinks: [
            {
        ...
        },
        {
          ...
          content:
            "Tháng 3/2024, Professional Pickleball Association (PPA) và Major League Pickleball (MLP) chính thức sáp nhập thành một công ty mẹ duy nhất: United Pickleball Association — UPA. Thương vụ nhận đầu tư 75 triệu USD từ quỹ private equity SC Holdings và thống nhất hai tổ chức đã trải qua gần như cả năm 2023 trong cuộc chiến giành VĐV gay gắt. Tính đến 2026, UPA là công ty mẹ sở hữu cả PPA Tour và MLP. PPA Tour Asia hoạt động như đối tác khu vực liên kết với UPA. Lưu ý quan trọng: APP Tour KHÔNG thuộc UPA — vẫn độc lập. Tham vọng nền tảng đó trở thành hiện thực vào tháng 5/2026, khi Apollo Sports Capital dẫn đầu khoản đầu tư 225 triệu USD vào một công ty mẹ mới đặt tên Pickleball Inc. (mở rộng từ holding UPA), định giá doanh nghiệp khoảng 750 triệu USD — với Tom Dundon và gia đình Pardoe vẫn là cổ đông đa số. Nguồn vốn này tài trợ cho nhiều hợp đồng phát sóng hơn, mở rộng quốc tế, và tích hợp chặt chẽ hơn với hệ thống xếp hạng DUPR cùng các nền tảng bán lẻ và công nghệ như Pickleball Central và PickleballTournaments.com.",
          internalLinks: [
            {
