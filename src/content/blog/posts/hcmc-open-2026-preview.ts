...
const post: BlogPost = {
  ...
  content: {
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          listItems: [
            ...
            "Tier: PPA Asia 500 — the second-highest regular tier on the 2026 tour",
            "Prize money: US$70,000 total",
            "Ranking points: 500 PPA points to gold medalists — counted in the unified global PPA ranking",
            "Title sponsor: MB (Military Commercial Joint Stock Bank), with JOOLA as equipment partner and Facolos, Franklin and Paddletek as paddle partners",
            "Events: pro men's and women's singles, men's and women's doubles, and mixed doubles — plus full amateur draws by rating and age",
            "Spectator tickets: on sale via Ticketbox, the organizer's official seller — prices and day passes are listed there",
            "Amateur competition entry (to play, not to watch): open now via pickleballbrackets.com",
          ],
          internalLinks: [
            {
              text: "Buy HCMC Open 2026 spectator tickets on Ticketbox",
              path: "https://ticketbox.vn/ppa-asia-500-mb-hcmc-open-2026-26355",
            },
          ],
        },
        {
          heading: "The venue: New Sports Club at The Global City",
          content:
            "The Global City is a 117-hectare new urban district in Thu Duc City on Ho Chi Minh City's eastern side, and its sports complex was built with international events in mind. The pickleball setup combines international-spec outdoor courts with seating for 300+ spectators and the climate-controlled TGC Arena — a meaningful detail for an event scheduled in the middle of southern Vietnam's rainy season. PPA Tour Asia used the same city for the MB Vietnam Open in 2025, but New Sports Club gives the 2026 edition a bigger, purpose-built stage. If you are traveling in for the event and want to get some games in yourself, Ho Chi Minh City has one of the densest pickleball court networks in Asia.",
          internalLinks: [
            {
              text: "Find pickleball courts in Ho Chi Minh City and across Vietnam",
              path: "/san",
            },
          ],
        },
        {
          heading: "Prize money and ranking points: the full breakdown",
          content:
            "The US$70,000 purse is split across singles and doubles draws, with 500 ranking points going to gold. Here is the official breakdown per result (doubles figures are per team):",
          listItems: [
            ...
            "4th place: $595 singles / $1,450 doubles — 200 points",
        ...
        {
          heading: "Amateur draws: how to enter",
          content:
            "Like every PPA Tour Asia stop, the HCMC Open is open to amateur players — you can compete at the same venue, in the same week, as the pros. The amateur competition is organized two ways: by rating (under 3.5, and 3.5 and above) and by age group (U18, 19+, 35+, 50+), across men's and women's singles, men's and women's doubles, and mixed doubles. Players are rated on the DUPR scale from 2.0 to 8.0 — amateurs from 2.0 to 5.0 — so you will be placed against opponents of a similar level. Registration is live at pickleballbrackets.com, and places are limited, so if you want to play rather than just watch, enter early. If you are not sure what your DUPR rating means or how to get one, start with our guide.",
          internalLinks: [
            {
        ...
        {
          heading: "How to watch the HCMC Open",
          content:
            "If you are in Ho Chi Minh City during the tournament, the outdoor stadium court seats 300+ and the event is built as a fan experience — four days of top-level competition in the heart of the city. If you can't be there, PPA Tour Asia streams its events on its official YouTube channel, and ThePickleHub's live hub tracks streams, scores and schedules for every major event relevant to Vietnamese fans throughout the week. We will publish the daily schedule and court assignments once the tournament week begins.",
          internalLinks: [
            {
      ...
      faqItems: [
        {
          question: "When and where is the HCMC Open 2026?",
          answer:
            "The MB Ho Chi Minh City Open runs August 6–9, 2026 at New Sports Club (City Park at The Global City) in Thu Duc City, Ho Chi Minh City, Vietnam. It is a 500-level PPA Tour Asia stop.",
        },
        {
          question: "How do I buy tickets to watch the HCMC Open 2026?",
          answer:
            "Spectator tickets are sold on Ticketbox, the official seller for organizers UPA Asia and New Sports JSC. Prices, ticket types and day passes are listed on the Ticketbox event page. Note that this is separate from pickleballbrackets.com, which is for entering the amateur competition, not for watching.",
        },
        {
          question: "How much prize money is at the HCMC Open 2026?",
          answer:
            "US$70,000 in total. Gold medalists earn $2,000 in singles and $5,500 per team in doubles, along with 500 PPA ranking points that count toward the unified global PPA ranking.",
        },
        {
          question: "Can amateur players compete at the HCMC Open?",
          answer:
            "Yes. The event includes amateur draws by rating (under 3.5, and 3.5+) and by age group (U18, 19+, 35+, 50+) in singles, doubles and mixed doubles. Registration is open at pickleballbrackets.com and places are limited.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "PPA Tour Asia streams its events on its official YouTube channel. ThePickleHub's live hub tracks streams, scores and schedules throughout the tournament week, and the venue itself seats 300+ spectators if you are in Ho Chi Minh City.",
        },
      ],
    },
    vi: {
      ...
      sections: [
        ...
        },
        {
          ...
          listItems: [
            ...
            "Địa điểm: New Sports Club, City Park thuộc The Global City, TP.HCM",
            "Cấp giải: PPA Asia 500 — cấp cao thứ hai trong hệ thống tour 2026",
            "Tổng thưởng: 70.000 USD",
            "Điểm xếp hạng: 500 điểm PPA cho nhà vô địch — tính vào bảng xếp hạng PPA toàn cầu",
            "Nhà tài trợ: MB (tài trợ chính), JOOLA (đối tác trang thiết bị), Facolos, Franklin và Paddletek (đối tác vợt)",
            "Nội dung: đơn nam/nữ, đôi nam/nữ và đôi hỗn hợp chuyên nghiệp — kèm đầy đủ nhánh nghiệp dư theo trình độ và độ tuổi",
            "Vé xem: bán trên Ticketbox — kênh bán vé chính thức của BTC; giá vé và vé theo ngày xem trực tiếp trên đó",
            "Đăng ký thi đấu nghiệp dư (để chơi, không phải để xem): đang mở tại pickleballbrackets.com",
          ],
        },
        {
          heading: "Địa điểm: New Sports Club, The Global City",
          content:
            "The Global City là khu đô thị mới rộng 117 ha tại TP. Thủ Đức, phía Đông TP.HCM, với khu liên hợp thể thao được xây để phục vụ các sự kiện quốc tế. Hệ thống sân pickleball tại đây kết hợp sân ngoài trời chuẩn quốc tế với khán đài hơn 300 chỗ và nhà thi đấu TGC Arena có điều hòa — chi tiết đáng chú ý cho một giải đấu diễn ra giữa mùa mưa miền Nam. PPA Tour Asia từng tổ chức MB Vietnam Open 2025 tại TP.HCM, nhưng New Sports Club cho phiên bản 2026 một sân khấu lớn hơn và chuyên dụng hơn. Nếu bạn đến TP.HCM xem giải và muốn tự cầm vợt ra sân, thành phố này có mạng lưới sân pickleball dày đặc bậc nhất châu Á.",
          internalLinks: [
            {
              text: "Tìm sân pickleball tại TP.HCM",
              path: "/vi/san/khu-vuc/tp-hcm",
            },
          ],
        },
        {
          heading: "Tiền thưởng và điểm xếp hạng: chi tiết đầy đủ",
          content:
            "Tổng thưởng 70.000 USD được chia cho các nhánh đơn và đôi, với 500 điểm xếp hạng cho HCV. Đây là mức thưởng chính thức theo từng thành tích (giải đôi tính theo đội):",
          listItems: [
            "HCV: 2.000 USD đơn / 5.500 USD đôi — 500 điểm",
            "HCB: 1.000 USD đơn / 3.000 USD đôi — 400 điểm",
            "HCĐ: 800 USD đơn / 1.800 USD đôi — 300 điểm",
            "Hạng 4: 595 USD đơn / 1.450 USD đôi — 200 điểm",
            "Tứ kết: 395 USD đơn / 800 USD đôi — 100 điểm",
            "Vòng 16: 195 USD đơn / 420 USD đôi — 50 điểm",
          ],
        },
        {
        ...
        {
          heading: "Nhánh nghiệp dư: đăng ký thế nào",
          content:
            "Như mọi chặng PPA Tour Asia, HCMC Open mở cửa cho người chơi nghiệp dư — bạn có thể thi đấu cùng địa điểm, cùng tuần với các VĐV chuyên nghiệp. Giải nghiệp dư chia hai cách: theo trình độ (dưới 3.5, và từ 3.5 trở lên) và theo nhóm tuổi (U18, 19+, 35+, 50+), ở các nội dung đơn nam/nữ, đôi nam/nữ và đôi hỗn hợp. VĐV được xếp theo thang điểm DUPR từ 2.0 đến 8.0 — nghiệp dư từ 2.0 đến 5.0 — nên bạn sẽ gặp đối thủ cùng trình độ. Đăng ký đang mở tại pickleballbrackets.com và số chỗ có hạn, nên nếu muốn thi đấu thay vì chỉ xem, hãy đăng ký sớm. Nếu chưa rõ điểm DUPR là gì và cách có điểm, hãy bắt đầu từ bài hướng dẫn của chúng tôi.",
          internalLinks: [
            {
        ...
        {
          heading: "Xem HCMC Open ở đâu",
          content:
            "Nếu bạn ở TP.HCM trong tuần diễn ra giải, sân vận động ngoài trời có hơn 300 chỗ ngồi và sự kiện được thiết kế như một trải nghiệm cho khán giả — bốn ngày thi đấu đỉnh cao giữa lòng thành phố. Nếu không thể đến sân, PPA Tour Asia phát trực tiếp trên kênh YouTube chính thức, và chuyên mục Live của ThePickleHub tổng hợp link xem, tỷ số và lịch thi đấu của mọi sự kiện lớn trong suốt tuần giải. Chúng tôi sẽ đăng lịch thi đấu từng ngày khi tuần giải bắt đầu.",
          internalLinks: [
            {
      ...
      faqItems: [
        {
          question: "HCMC Open 2026 diễn ra khi nào, ở đâu?",
          answer:
            "MB Ho Chi Minh City Open diễn ra từ 6 đến 9/8/2026 tại New Sports Club (City Park, The Global City), TP. Thủ Đức, TP.HCM. Đây là chặng PPA Tour Asia cấp 500.",
        },
        {
          question: "Mua vé xem HCMC Open 2026 ở đâu?",
          answer:
            "Vé xem bán trên Ticketbox — kênh chính thức của BTC (UPA Asia và New Sports JSC). Giá vé, loại vé và vé theo ngày xem trực tiếp trên trang sự kiện Ticketbox. Lưu ý phân biệt với pickleballbrackets.com: đó là nơi đăng ký thi đấu nghiệp dư, không phải mua vé xem.",
        },
        {
          question: "Tổng tiền thưởng HCMC Open 2026 là bao nhiêu?",
          answer:
            "70.000 USD. Nhà vô địch nhận 2.000 USD ở nội dung đơn và 5.500 USD mỗi đội ở nội dung đôi, kèm 500 điểm PPA tính vào bảng xếp hạng toàn cầu hợp nhất.",
        },
        {
          question: "Người chơi nghiệp dư có được thi đấu tại HCMC Open không?",
          answer:
            "Có. Giải mở các nhánh nghiệp dư theo trình độ (dưới 3.5 và từ 3.5 trở lên) và nhóm tuổi (U18, 19+, 35+, 50+) ở nội dung đơn, đôi và đôi hỗn hợp. Đăng ký tại pickleballbrackets.com, số chỗ có hạn.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "PPA Tour Asia phát trực tiếp trên kênh YouTube chính thức. Chuyên mục Live của ThePickleHub tổng hợp link xem, tỷ số và lịch thi đấu suốt tuần giải, còn nếu ở TP.HCM bạn có thể đến sân với hơn 300 chỗ ngồi.",
        },
      ],
    },
  },
