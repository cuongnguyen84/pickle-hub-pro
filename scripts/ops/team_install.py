...
def install():
    ...
    for name in ("team_supervisor.py", "team_store.py", "team_workspace.py", "team_codex.py", "team_progress.py", "team_seo.py", "team_content.py", "team_content_plan.json", "team_roles.json", "team_watchdog.py", "team_ga4.py", "ops_sweep.py", "chief_brief.py"):
