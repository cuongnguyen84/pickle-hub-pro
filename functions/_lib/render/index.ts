...
const BLOG_POST_META: Record<string, {
  ...
  "pickleball-club-management-software-comparison": { title: "Best Pickleball Club Management Software in 2026 — Honest Comparison", description: "Compare the best pickleball club management software in 2026 — CourtReserve, Playtomic, PlayByPoint, ClubSpark, Pickle Planner and more. Features, pricing, and a realistic low-cost stack for Vietnamese clubs.", datePublished: "2026-06-15" },
  "pickleball-tournament-budget-calculator-guide": { title: "Pickleball Tournament Budget: Full Cost Breakdown, Templates & Free Calculator (2026)", description: "How much does it cost to run a pickleball tournament? Full 2026 cost breakdown in USD and VND, 3 ready budget templates, a break-even entry fee formula, and a free spreadsheet.", datePublished: "2026-06-13" },
