...
const BLOG_POST_META: Record<string, {
  ...
  "vietnam-hosts-ppa-tour-asia-2026": { title: "Vietnam Hosts PPA Tour Asia 2026: HCMC Open, World Cup Da Nang and a Historic Season", description: "In 2026 Vietnam hosts two PPA Tour Asia stops — the $300,000 MB Hanoi Cup and the HCMC Open (Aug 6–9) — plus the first Pickleball World Cup ever held in Asia (Da Nang, Aug 30–Sep 6). How Vietnam became the center of Asian pickleball.", datePublished: "2026-07-13" },
