...
|---|---|---|---|---|---|
| Debug | `net.thepicklehub.app` | `2.1.6 (12)` | production | ON | OFF |
| Release | `net.thepicklehub.app` | `2.1.6 (12)` | production | ON | ON |

`2.1.6 (12)` nối tiếp bản đã upload `2.1.5 (10)` và sửa chia cặp playoff quick-table
(#744 #745 #746: cặp cổ điển 2/4/8 bảng, resolver v2 đúng, preview + đổi cặp) + tab WPR trên Xếp hạng (#748). Nếu App Store Connect
