...
| QA-04 | partial | 5d | Add stable E2E coverage for ten critical journeys — **stabilize DONE 2026-07-22 (#432)**: mint-race fixed (auth-setup storageState), fail-hard on CI, DUPR SSO active; ten journeys remain (deferred inc4) | BASE-04, QA-03 |
