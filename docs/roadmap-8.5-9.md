...
| PERF-05 | done | 3d | Validate CWV p75 targets with Vietnam field data. **Read 2026-07-28, verdict GIỮ** (docs/perf-05-report-2026-07-28.md): LCP p75 mobile 2684→2423ms crossed into good after #389+#417; CLS p75 ~0.67 POOR pre-existing both windows (NOT a regression — needs its own /idea with CLS attribution); INP no CrUX sample. GA4 gap found+fixed: metric_name/metric_rating were never registered (21/07 batch was funnel/badge only) — registered 28/07, follow-up read = milestone PERF-05B 2026-08-05 | PERF-02..PERF-04 |
...
| OPS-04 | partial | 4d | Build actionable dashboards and alerts tied to SLOs — **inc1 DONE 2026-07-22 (#432)**: uptime-ping (SLO-1 gap) + milestone-due watchdog + alert_count fix; burn-alert deferred until funnel events queryable | OPS-03, BASE-03 |
...
Remaining open work: **OPS-04** (inc1 done #432 — burn-alert deferred) · **PERF-05 done 28/07 verdict GIỮ** (follow-up PERF-05B 05/08; new P1 finding: CLS p75 mobile ~0.67 pre-existing, needs its own /idea) · **UX-07** partial — continue-or-close on the ~02/08 funnel read (D5 unmeasured) · **CLOSE-03/04** (now nearly satisfiable) · blocked: BASE-07 (participants), UX-09 (participants), A11Y-05 (devices).
