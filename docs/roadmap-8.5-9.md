...
Last updated: **2026-08-03** after SEO checklist v2 (#530), VI venue links + byte titles (#533), TheLine Rule 4 HARD (#534), UX-07 funnel read → CLOSE (`31a71f54`), weekly /san tracker (SEO-SAN-W33). Counts: **69 done · 0 partial · 2 later (CLOSE-03/04) · 3 closed-by-decision (BASE-07, UX-07, UX-09) · 0 blocked** (A11Y-05 done 22/07 tay — note "blocked: devices" cũ tự mâu thuẫn).

Remaining open work: **CLOSE-03** final audit (contrast debt behind `tests/a11y.spec.ts:82` blanket rule; CLS 0.67 re-read ≥30/08; lint/type/build re-check) · **CLOSE-04** scorecard (after CLOSE-03) · milestones due: BADGE-TELEMETRY (04/08), PERF-05B (05/08), SEO-SAN-W33 (10/08), SEO-CLUSTER-READ (23/08) · SEO checklist items 2-5 (`docs/seo-followup-2026-08.md`).
