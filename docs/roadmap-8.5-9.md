...
| OPS-04 | partial | 4d | Build actionable dashboards and alerts tied to SLOs — **inc1 DONE 2026-07-22 (#432)**: uptime-ping (SLO-1 gap) + milestone-due watchdog + alert_count fix; **inc2 02-03/08: #525 AdminJobs dashboard + Telegram morning digest + self-heal, #528 alert dedupe.** CÒN: burn-rate/error-budget alert theo `docs/slo.md` — lý do defer cũ ("funnel events queryable") hết hiệu lực từ 03/08 | OPS-03, BASE-03 |
