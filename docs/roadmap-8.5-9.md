...
Last updated: 2026-07-15 after completing SEC-04.

- Active task: none. `HOT-01`..`HOT-04`, `HOT-06`, `HOT-07`, `BASE-01`, minimum-scope `BASE-03`, `BASE-06`, `OPS-00`, `SEC-02`, `SEC-03`, `SEC-04`, `QA-06`, and `PERF-06` are complete.
- Next task: `BE-01`, now unblocked by SEC-04; consolidate the 37 inline CORS copies into `_shared/cors.ts` and migrate the seven legacy `std@0.168 serve` handlers to `Deno.serve` with characterization coverage.
