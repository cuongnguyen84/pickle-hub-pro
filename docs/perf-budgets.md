...
- Total gzipped JS: **1904.0 KB** (guard at 1970 after two stopgap bumps:
...
|---|---:|---:|---|
| Total gz JS (CI-enforced) | ratchet: 1970 now → **1850** after PERF-02 → re-evaluate | 1904.0 | PERF-02 |
